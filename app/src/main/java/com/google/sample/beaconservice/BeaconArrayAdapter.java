...
class BeaconArrayAdapter extends ArrayAdapter<Beacon> {
  ...
  public View getView(final int position, View convertView, ViewGroup parent) {
    ...
    TextView status = (TextView) convertView.findViewById(R.id.beaconStatus);
    status.setText("Status: " + beacon.status);

    TextView placeId = (TextView) convertView.findViewById(R.id.beaconPlaceId);
    placeId.setText("PlaceId: " + beacon.placeId);

    TextView lat = (TextView) convertView.findViewById(R.id.beaconLat);
    lat.setText("Latitude: " + beacon.latitude);

    TextView lng = (TextView) convertView.findViewById(R.id.beaconLong);
    lng.setText("Longitude: " + beacon.longitude);

    TextView stability = (TextView) convertView.findViewById(R.id.expectedStability);
    stability.setText("Expected Stability: " + beacon.expectedStability);

    TextView desc = (TextView) convertView.findViewById(R.id.expectedDescription);
    desc.setText("Description: " + beacon.description);
